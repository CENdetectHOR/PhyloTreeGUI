...
def start(path=os.getcwd(), threshold=75.0, folder=None, fullscreen=None):
    ...
    GUIFactory.create_gui(root, path=path, threshold=threshold, folder=folder)
    root.mainloop()
...
if __name__ == "__main__":
    ...
    start(path=arg.path, threshold=arg.threshold, folder=arg.folder, fullscreen=arg.fullscreen)
