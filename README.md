...
python main.py [--path <path/to/dir/with/phylo/xml/files>] [--folder <dir/where/to/save/output/files>] [--threshold <threshold>] [--fullscreen]
...
3) threshold level defining the minimum percentage of sequence coverage (default is 75, corresponding to 75% coverage);
